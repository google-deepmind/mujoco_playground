...
from mujoco_playground._src.mj_utils import geoms_colliding  # pylint: disable=g-importing-member
import numpy as np


def default_config() -> config_dict.ConfigDict:
  # TODO(kevin): Add time delays.
  # TODO: Add sensor specific noise types.
  return config_dict.create(
      ...
      # Minimum and maximum durations of perturbation kicks, in seconds.
      kick_durations=[0.05, 0.2],
      # Minimum and maximum wait times before next perturbation kick, in
      # seconds. A duration will be sampled uniformly from this range at the
...
class Joystick(go1_base.Go1Env):
  ...
  def reset(self, rng: jax.Array) -> mjx_env.State:
    ...
    obs_history = jp.zeros(self._config.obs_history_size * 36)
